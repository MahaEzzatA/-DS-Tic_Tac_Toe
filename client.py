...
greeting = Label(text="Welcome Folks!", font=('Helvetica', '15'))
waiting_lb = Label(text="waiting for another player!...", font=('Helvetica', '15'))
player_turn_lb = Label(text="Opponent Turn", font=('Helvetica', '15'))
your_turn_lb = Label(text="Your Turn", font=('Helvetica', '15'))
